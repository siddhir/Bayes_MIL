...
def main(args):
    ...
    final_df = pd.DataFrame({'folds': folds, 'test_auc': all_test_auc, 
        'val_auc': all_val_auc, 'test_acc': all_test_acc, 'val_acc' : all_val_acc, 'test_ece_loss': all_test_ece_loss,
...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'clam_mb', 'mil', 'msa', 'pmil-V', 
                                                        'pmil-C', 'pmil-N', 'bmil-A', 'bmil-F', 'bmil-vis', 'mil_baens', 'hmil', 'smil-D'],
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/testing_cases.csv',
