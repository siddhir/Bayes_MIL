...
def eval(dataset, args, ckpt_path):
    ...
    patient_results, test_error, auc, ece_loss, val_loss, df, _ = summary(model, loader, args)
    print('test_error: ', test_error)
    print('auc: ', auc)
    return model, patient_results, test_error, auc, ece_loss, val_loss, df
...
def summary(model, loader, args):
    ...
    return patient_results, test_error, auc_score, ece_loss, val_loss, df, acc_logger
